...
def train_gans(lst_saved_models, dataloaders, trial, alpha, num_gans=1, num_epochs=2000, 
...
def repeatTrain(dataloaders, trial, epoch_len, alpha,  end, start=0):
    ...
    """
    lst_saved_models = [None for _ in range(1)]
    ...
    while prev_stop < end:
        ...
        train_gans(lst_saved_models, dataloaders, num_gans=1, num_epochs=next_stop, trial=trial, 
...
def main(train_size=10, model_size=1, trial=2):
    num_gans = 1
